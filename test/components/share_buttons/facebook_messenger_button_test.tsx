...
describe('FacebookMessengerButton', () => {
  ...
  it('does render if boxShadow is true', () => {
    const element = shallow(
      <FacebookMessengerButton shareUrl={shareUrl} shape={shape} facebookAppId={facebookAppId} boxShadow />
    )
    expect(element).toMatchSnapshot()
  })
  ...
  it('does render if teaser are provided', () => {
    const element = shallow(
      <FacebookMessengerButton shareUrl={shareUrl} shape={shape} facebookAppId={facebookAppId} teaser="Hello there" />
    )
    expect(element).toMatchSnapshot()
  })
