...
Note that [`src/javascript/apiV4.ts`](src/javascript/apiV4.ts) is a file autogenerated from betterplaces API and needs to be manually copied over during development and release when relevant betterplace API parts changed.
